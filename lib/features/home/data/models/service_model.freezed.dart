...
@override
String toString() {
  return 'ServiceModel(id: $id, ownerId: $ownerId, title: $title, description: $description, price: $price, isAvailable: $isAvailable)';
}
...
class _ServiceModel implements ServiceModel {
  const _ServiceModel({required this.id, required this.ownerId, required this.title, required this.description, required this.price, required this.isAvailable});
